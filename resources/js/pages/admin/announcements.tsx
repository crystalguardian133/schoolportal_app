...
import { ImagePlus, Link2, Sparkles, Paperclip, Pencil, Trash2, ChevronDown } from 'lucide-react';
...
export default function AdminAnnouncements({
    ...
    function showToast(message: string, type: 'success' | 'error' = 'success') {
        window.dispatchEvent(new CustomEvent('local-toast', { detail: { message, type, link: '/admin/announcements', linkLabel: 'View announcements' } }));
    }
...
return;
        ...
        router.patch(`/admin/announcements/${editAnnouncement.uuid}`, payload, {
            ...
            onError: (errors) => {
                const firstError = Object.values(errors || {})[0];
                showToast((firstError as string) || 'Unable to update announcement.', 'error');
            },
        });
    }
    ...
    function handleSortChange(nextSort: string) {
        ...
        router.get('/admin/announcements', { sort: nextSort }, { preserveState: true, preserveScroll: true });
    }
                ...
                <div className="grid gap-4 lg:grid-cols-[380px_minmax(0,1fr)]">
                    ...
                    <div className="rounded-2xl border border-sidebar-border/70 bg-white p-5 shadow-sm dark:border-sidebar-border dark:bg-sidebar">
                        <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
                            <div className="text-sm font-semibold text-foreground dark:text-sidebar-foreground">Recent announcements</div>
                        ...
                        <form onSubmit={submitEdit} className="space-y-4 mt-2">
                            ...
                            <div className="grid gap-2">
                                ...
                                <div className="flex items-center gap-3">
                                    {editImagePreview ? (
                                        <img src={editImagePreview} alt={editAnnouncement.title} className="h-32 w-32 rounded-xl object-cover" />
                                    ) : (
