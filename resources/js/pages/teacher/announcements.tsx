...
export default function TeacherAnnouncements() {
    ...
    function submitEdit(e: React.FormEvent) {
        ...
        payload.append(
            'class_section_uuid',
            editAnnouncement.class_section_uuid ?? '',
        );
        ...
        router.patch(
            `/teacher/announcements/${editAnnouncement.uuid}`,
            payload,
            {
    ...
    return (
        <>
            ...
            <PortalPageShell
                title="Announcements"
                description="View school notices and staff reminders."
            >
                        ...
                        {announcements.length === 0 ? (
                            ...
                            announcements.map((announcement) => (
                                <article
                                    ...
                                    className="rounded-xl border border-sidebar-border/70 px-4 py-3"
                                >
                                    <button
                                        type="button"
                                        onClick={() =>
                                    ...
                                    >
                                        ...
                                        <p className="mt-3 text-sm leading-6 whitespace-pre-line text-sidebar-foreground">
                                            {announcement.body}
                                        </p>
                                    </button>
