                ...
                >
                    {({ processing, errors }) => (
                        <div className="space-y-10 rounded-3xl border border-sidebar-border/70 bg-white p-8 shadow-sm dark:border-sidebar-border dark:bg-sidebar">
                                ...
                                <div className="grid gap-3">
                                    <div className="flex items-end justify-between gap-3">
                                        ...
                                        <span className="text-xs text-muted-foreground">
                                            This is saved as one display name
                                        </span>
                                    </div>
                            ...
                            <div className="space-y-6 border-t border-sidebar-border/70 pt-8">
                                <h2 className="text-base font-semibold text-foreground">
                                    Profile photo
                                </h2>
                                <p className="mt-1 text-sm text-muted-foreground">
                                    ...
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div className="max-w-sm space-y-2 text-sm text-muted-foreground">
                                            <p className="font-medium text-foreground">
                                                Recommended: square image, up to
                                                2MB.
                                            </p>
                                            <p>
                                                The new photo will replace the
                                                current one after you save
                                                changes.
                                            </p>
                                        </div>
                                    </div>
